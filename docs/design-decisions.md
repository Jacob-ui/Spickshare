...
### Context  
Bisher Raw-SQL genutzt, aber für `flask_login` brauchen wir eine User-Klasse, was zu SQLAlchemy ORM nahelegt.
...
## Designentscheidung 10: Keine Aufteilung in Blueprints oder separate View-Dateien für kleines Projekt

### Kontext  
Das Projekt ist überschaubar und enthält hauptsächlich Kernfunktionen wie Login, Cheatsheets und Käufe. Eine Aufteilung in viele Dateien (Blueprints) würde unnötige Komplexität verursachen.

### Entscheidung  
Wir behalten die gesamte Logik in einer zentralen `app.py` Datei, solange das Projekt klein bleibt.

### Status  
Akzeptiert – 2025-07-20

### Konsequenzen  
+ Einfachere Navigation für kleine Teams oder Einzelentwickler  
+ Weniger Setup-Aufwand (keine Blueprints, Imports, Konfigs)  
+ Gut geeignet für schnelle Entwicklung und MVPs  
- Kann bei wachsender Codebasis schnell unübersichtlich werden  
- Schwerer zu testen oder in Teams parallel zu bearbeiten

### Alternative Überlegungen  
**Verwendung von Blueprints und modularen Views**  
- Besser für große Anwendungen, aber Overhead für kleine Projekte
